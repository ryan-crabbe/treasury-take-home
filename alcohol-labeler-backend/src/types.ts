// Backend types - consistent with frontend types.ts
...
// Backend-specific types for handling form data
export interface CreateLabelValidationDto {
  brandName: string;
  productClass: string;
  alcoholContent: number;
  netContents?: string;
  labelImage: Express.Multer.File;
}
